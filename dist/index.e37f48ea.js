...
const AppView = {
    ...
    mapEvent: "",
    workouts: [],
    mapZoomLevel: (0, _configJs.MAX_ZOOM)
};
...
const addHandlerNewWorkout = function(helper) {
    form.addEventListener("submit", helper);
};
const addHandlerToggleWorkout = function() {
...
parcelHelpers.export(exports, "POPUP_MAX_WIDTH", ()=>POPUP_MAX_WIDTH);
parcelHelpers.export(exports, "POPUP_MAX_HEIGHT", ()=>POPUP_MAX_HEIGHT);
parcelHelpers.export(exports, "PAN_DURATION_SEC", ()=>PAN_DURATION_SEC);
const MAX_ZOOM = 13;
const POPUP_MAX_WIDTH = 250;
const POPUP_MAX_HEIGHT = 100;
const PAN_DURATION_SEC = 1;
...
class Cycling extends (0, _workoutJsDefault.default) {
    ...
    validateNewCyclingWorkout(data) {
        ...
        if (data.type === "Cycling") {
            ...
            console.log(msg);
            if (Number.isNaN(data.elevation)) msg += "Please enter elevation gain as a number. \n";
        }
        return msg;
    }
}
...
class Workout {
    ...
    _setDescription() {
        ...
        this.setDescription = `${this.type[0].toUpperCase()}${this.type.slice(1)} on ${months[this.date.getMonth()]} ${this.date.getDate()}`;
    ...
    validateNewWorkout(data) {
        let msg = "";
        if (Number.isNaN(data.distance)) msg += "Please enter Distance as a number. \n";
        else if (data.distance <= 0) msg += "Please enter Distance as a positive value. \n";
        if (Number.isNaN(data.duration)) msg += "Please enter Duration as a number. \n";
        else if (data.duration <= 0) msg += "Please enter Duration as a positive value. \n";
        return msg;
    }
}
exports.default = Workout;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsv5J":[function(require,module,exports) {
...
class Running extends (0, _workoutJsDefault.default) {
    ...
    validateNewRunningWorkout(data) {
        ...
        if (data.type === "running") {
            msg = super.validateNewWorkout(data);
            if (Number.isNaN(data.cadence)) msg += "Please enter Cadence as a number. \n";
            else if (data.cadence <= 0) msg += "Please enter Cadence as a positive value. \n";
        }
        return msg;
    }
}
