...
init(); //Refactor fetching local storage data and rendering markers.

},{"./view":"ky8MP"}],"ky8MP":[function(require,module,exports) {
...
class app {
    ...
    _newWorkout(e) {
        ...
        const validate = function(distance, duration, type, gainOrcadence) {
            ...
            // check for negative
            let msg = "";
            if (Number.isNaN(distance)) msg += "Please enter Distance as a number. \n";
            else if (distance < 0) msg += "Please enter Distance as a positive value. \n";
            if (Number.isNaN(duration)) msg += "Please enter Duration as a number. \n";
            else if (duration < 0) msg += "Please enter Duration as a positive value. \n";
            if (type === "running") {
                if (Number.isNaN(gainOrcadence)) msg += "Please enter Cadence as a number. \n";
                else if (gainOrcadence < 0) msg += "Please enter Cadence as a positive value. \n";
            } else if (type === "cycling") {
                if (Number.isNaN(gainOrcadence)) msg += "Please enter Gain as a number. \n";
            }
            return msg;
        };
    ...
    _renderWorkout(workout) {
      ...
      <li class="workout workout--${workout.type}" data-id="${workout.id}">
        ...
        if (workout.type === "running") copyHTML += `
          <div class="workout__details">
        ...
        else if (workout.type === "cycling") copyHTML += `
          <div class="workout__details">
            <span class="workout__icon">⚡️</span>
...
},{}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire8112")
